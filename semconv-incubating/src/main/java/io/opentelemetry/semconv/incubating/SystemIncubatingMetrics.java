...
public final class SystemIncubatingMetrics {
  ...
  public static final String SYSTEM_DISK_IO_DESCRIPTION = "Disk bytes transferred.";
  ...
  public static final String SYSTEM_DISK_MERGED_DESCRIPTION =
  ...
  public static final String SYSTEM_DISK_OPERATIONS_DESCRIPTION = "Disk operations count.";
  ...
  /** Name of the {@code system.memory.linux.available} metric. */
  public static final String SYSTEM_MEMORY_LINUX_AVAILABLE_NAME = "system.memory.linux.available";

  /** Unit of the {@code system.memory.linux.available} metric. */
  public static final String SYSTEM_MEMORY_LINUX_AVAILABLE_UNIT = "By";

  /** Description of the {@code system.memory.linux.available} metric. */
  public static final String SYSTEM_MEMORY_LINUX_AVAILABLE_DESCRIPTION =
      "An estimate of how much memory is available for starting new applications, without causing swapping.";

  /** Name of the {@code system.memory.linux.hugepages.limit} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_LIMIT_NAME =
      "system.memory.linux.hugepages.limit";

  /** Unit of the {@code system.memory.linux.hugepages.limit} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_LIMIT_UNIT = "{page}";

  /** Description of the {@code system.memory.linux.hugepages.limit} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_LIMIT_DESCRIPTION =
      "Total number of hugepages available.";

  /** Name of the {@code system.memory.linux.hugepages.page_size} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_PAGE_SIZE_NAME =
      "system.memory.linux.hugepages.page_size";

  /** Unit of the {@code system.memory.linux.hugepages.page_size} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_PAGE_SIZE_UNIT = "By";

  /** Description of the {@code system.memory.linux.hugepages.page_size} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_PAGE_SIZE_DESCRIPTION =
      "System hugepage size in bytes.";

  /** Name of the {@code system.memory.linux.hugepages.reserved} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_RESERVED_NAME =
      "system.memory.linux.hugepages.reserved";

  /** Unit of the {@code system.memory.linux.hugepages.reserved} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_RESERVED_UNIT = "{page}";

  /** Description of the {@code system.memory.linux.hugepages.reserved} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_RESERVED_DESCRIPTION =
      "Number of reserved hugepages.";

  /** Name of the {@code system.memory.linux.hugepages.surplus} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_SURPLUS_NAME =
      "system.memory.linux.hugepages.surplus";

  /** Unit of the {@code system.memory.linux.hugepages.surplus} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_SURPLUS_UNIT = "{page}";

  /** Description of the {@code system.memory.linux.hugepages.surplus} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_SURPLUS_DESCRIPTION =
      "Number of surplus hugepages.";

  /** Name of the {@code system.memory.linux.hugepages.usage} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_USAGE_NAME =
      "system.memory.linux.hugepages.usage";

  /** Unit of the {@code system.memory.linux.hugepages.usage} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_USAGE_UNIT = "{page}";

  /** Description of the {@code system.memory.linux.hugepages.usage} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_USAGE_DESCRIPTION =
      "Number of hugepages in use by state.";

  /** Name of the {@code system.memory.linux.hugepages.utilization} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_UTILIZATION_NAME =
      "system.memory.linux.hugepages.utilization";

  /** Unit of the {@code system.memory.linux.hugepages.utilization} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_UTILIZATION_UNIT = "1";

  /** Description of the {@code system.memory.linux.hugepages.utilization} metric. */
  public static final String SYSTEM_MEMORY_LINUX_HUGEPAGES_UTILIZATION_DESCRIPTION =
      "Percentage of hugepages in use by state.";

  /** Name of the {@code system.memory.linux.shared} metric. */
  public static final String SYSTEM_MEMORY_LINUX_SHARED_NAME = "system.memory.linux.shared";

  /** Unit of the {@code system.memory.linux.shared} metric. */
  public static final String SYSTEM_MEMORY_LINUX_SHARED_UNIT = "By";

  /** Description of the {@code system.memory.linux.shared} metric. */
  public static final String SYSTEM_MEMORY_LINUX_SHARED_DESCRIPTION =
      "Shared memory used (mostly by tmpfs).";

  /** Name of the {@code system.memory.linux.slab.usage} metric. */
  public static final String SYSTEM_MEMORY_LINUX_SLAB_USAGE_NAME = "system.memory.linux.slab.usage";

  /** Unit of the {@code system.memory.linux.slab.usage} metric. */
  public static final String SYSTEM_MEMORY_LINUX_SLAB_USAGE_UNIT = "By";

  /** Description of the {@code system.memory.linux.slab.usage} metric. */
  ...
  public static final String SYSTEM_MEMORY_UTILIZATION_DESCRIPTION =
  ...
  public static final String SYSTEM_NETWORK_IO_DESCRIPTION =
  ...
  public static final String SYSTEM_NETWORK_PACKET_COUNT_DESCRIPTION =
      "The number of packets transferred.";
  ...
  public static final String SYSTEM_PAGING_FAULTS_DESCRIPTION = "The number of page faults.";
  ...
  public static final String SYSTEM_PAGING_OPERATIONS_DESCRIPTION =
